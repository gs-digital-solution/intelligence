# Generated by Django 5.2.4 on 2025-07-06 17:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fichier_pdf', models.FileField(upload_to='lecons/pdf/', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecons', models.ManyToManyField(blank=True, to='core.lecon', verbose_name='Leçons concernées')),
                ('matiere', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.matiere', verbose_name='Matière')),
                ('type_exercice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.typeexercice', verbose_name="Type d'exercice")),
            ],
            options={
                'verbose_name': 'Exercice',
                'verbose_name_plural': 'Exercices',
                'ordering': ['-date_creation'],
                'indexes': [models.Index(fields=['matiere', 'type_exercice'], name='core_exerci_matiere_cbf519_idx')],
            },
        ),
    ]
